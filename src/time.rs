...
// TODO: implement TryFrom for chrono::Duration
// TODO: Create trait SaturatingInto and implement for and chrono
...
mod tests {
    ...
    fn test_fundu_duration_checked_add_then_is_none(#[case] lhs: Duration, #[case] rhs: Duration) {
